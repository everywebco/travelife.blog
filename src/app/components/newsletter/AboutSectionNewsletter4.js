...
export default function AboutSectionNewsletter4() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap items-center -mx-4">
      <div className="w-full md:w-3/5 px-4 mb-6 lg:mb-0">
        <div className="flex items-center">
          <span className="mr-6 flex items-center justify-center w-16 h-16 p-3 bg-gray-500 rounded-full">
          ...
          <div>
            <h3 className="mb-1 text-3xl font-bold font-heading">Sign up to our newsletter</h3>
      ...
      <div className="w-full md:w-2/5 px-4">
        <form action="#">
          <div className="flex max-w-md">
            <input className="w-full pl-3 py-3 mr-2 border rounded" type="email" placeholder="Type your e-mail" />
            <button className="inline-block px-6 py-2 text-sm text-white font-bold leading-loose bg-gray-600 hover:bg-gray-700 rounded transition duration-200">Action</button>
          </div>
        </form>
      </div>
    </div>
