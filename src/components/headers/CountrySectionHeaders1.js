...
export default function CountrySectionHeaders1() {
    return (
        <React.Fragment>
            <>
  ...
  <nav className="navbar navbar-expand-lg navbar-light bg-light py-4 position-relative">
    <div className="container">
      ...
      <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#header04" aria-controls="header04" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div className="row">
      <div className="col-12 col-lg-8 mx-auto mb-5">
        <div className="text-center">
          ...
          <h2 className="display-3 fw-bold mt-2 mb-4">Take care of your performance every day.</h2>
          <a className="btn btn-primary" href="#">Try for Free</a>
        </div>
      </div>
    </div>
