...
export default function SpecialPlaceSectionFeatures7() {
    return (
        <React.Fragment>
            <>
    ...
    <div className="row">
      <div className="col-12 col-md-6 col-lg-4 mb-5">
        <div className="d-flex pe-md-5">
          ...
          <div>
            <h4>Security in saving</h4>
            <p className="text-muted">Take care to develop resources continually and integrity them with previous projects. More interesting writings for your customers.</p>
          </div>
        </div>
      </div>
      <div className="col-12 col-md-6 col-lg-4 mb-5">
