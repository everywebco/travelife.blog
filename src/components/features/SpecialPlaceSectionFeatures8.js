...
export default function SpecialPlaceSectionFeatures8() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container">
    <div className="row">
      <div className="col-12 col-lg-5">
        <img className="img-fluid mb-5 d-lg-none" src="bootstrap5-plain-assets/images/blue-400-square.png" alt />
        <h2 className="display-5 mb-4 fw-bold">Lorem Ipsum dolor sit amet</h2>
        <p className="lead text-muted mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque massa nibh, pulvinar vitae aliquet nec, accumsan aliquet orci.</p>
        <div className="d-flex mb-3">
          <div className="text-muted">
            <svg style={{width: 32, height: 32}} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="ms-3">
            <h5 className="fw-normal">Quick problem-solving contact</h5>
          </div>
        </div>
        <div className="d-flex mb-3">
          <div className="text-muted">
          ...
          <div className="ms-3">
            <h5 className="fw-normal">Making changes simple and easy</h5>
          </div>
        </div>
        <div className="d-flex">
          ...
          <div className="ms-3">
            <h5 className="fw-normal">Exchangeable at any time</h5>
          </div>
        </div>
      </div>
      <div className="d-none d-lg-block position-absolute top-0 end-0 h-100" style={{width: '50%', backgroundImage: 'url("bootstrap5-plain-assets/images/blue-400-square.png")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}} />
    </div>
  </div>
</section>
